 ...
 *
 * Derive the order of letters in this language, and return it. If the given input is invalid,
 * return "". If there are multiple valid solutions, return any of them.
 */
public class AlienDictionary {

  public String alienOrders(String[] words) {
